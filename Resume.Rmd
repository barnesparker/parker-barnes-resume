...
::: concise
-   Built a data pipeline that clusters facility networks based on clinician labor patterns, used to establish facility "metros".
-   Developed internal R package that interfaces with company's databases.
-   Automated monthly Stripe finance statements with RMarkdown; created tool in shiny to generate them interactively
-   Created an interactive Shiny dashboard that maps facilities and clinicians and plots their metrics.
:::
